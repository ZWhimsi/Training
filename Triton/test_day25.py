...
@pytest.mark.skipif(not IMPORT_SUCCESS, reason="Could not import from day25")
...
@pytest.mark.skipif(not CUDA_AVAILABLE, reason="CUDA not available")
def test_mha_output():
    """Test multi-head attention output."""
...
def test_full_attention():
    """Test full attention (scores -> softmax -> output)."""
    seq_len, head_dim = 64, 32
